...
function Admin_LandingPage(){
  ...
  const handleToProjectasAdmin  = (project_number, project_name) => {
  ...
  function displayprojects(){
      return(listofprojects.map((item,index)=>{
          ...
          <center >
            ...
            <center><button onClick={()=>handleToProjectasAdmin(1, listofprojects[index][3])} type="submit" className="btn">Go to Project : {listofprojects[index][3]}</button></center><br/><br/>
          </center>
            )}))
  }
